...
<div>
  ...
  <div class="main container">
    <div class="news_details">
      ...
      <span>发布时间：{{newsDetail.pubTime | mydate}}</span>
      <div class="news_content" v-html="newsDetail.content">
...
// console.log(this.nid);
     let url='http://127.0.0.1:8080/news/newsdetail/'+this.nid;
     this.$http.get(url).then(function (res) {
       this.newsDetail =res.body; //this值得是VM对象
       // console.log(res);
...
<style>
  .newscontent{ width: 100%; margin-top: 20px;}
